...
public class NodeTest {
    ...
    public void display_OperatorNode_printsTheEquation() {
        Node operatorNode = new OpNode(new Plus(), new ValueNode(1), new ValueNode(2));
        assertEquals("1 + 2", operatorNode.display());
    }

    @Test
    public void display_complexOperatorNodes() {
        Node f = new OpNode(new Multiply(), new ValueNode(2), new ValueNode(5));
        Node g = new OpNode(new Plus(), f, new ValueNode(3));
    ...
    public void compute_OperatorNode_givesTheComputedResult() {
        Node opsNode = new OpNode(new Minus(), new ValueNode(5), new ValueNode(3));
