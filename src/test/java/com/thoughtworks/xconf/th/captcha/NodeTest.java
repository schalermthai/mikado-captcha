...
public class NodeTest {
    ...
    public void display_OperatorNode_printsTheEquation() {
        Node operatorNode = OpNode.createOpNode(new Operator("+"), OpNode.createValueNode(1), OpNode.createValueNode(2));
        assertEquals("1 + 2", operatorNode.display());
    }

    @Test
    public void display_complexOperatorNodes() {
        Node f = OpNode.createOpNode(new Operator("*"), OpNode.createValueNode(2), OpNode.createValueNode(5));
        Node g = OpNode.createOpNode(new Operator("+"), f, OpNode.createValueNode(3));
    ...
    public void compute_OperatorNode_givesTheComputedResult() {
        Node opsNode = OpNode.createOpNode(new Operator("-"), OpNode.createValueNode(5), OpNode.createValueNode(3));
